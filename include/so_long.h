...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/17 13:53:38 by bcho              #+#    #+#             */
/*   Updated: 2023/01/18 20:39:37 by bcho             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_pos	get_newpos(t_pos prev, int idx);
int		dfs2(int row, int col, t_pos pos, char **map);
